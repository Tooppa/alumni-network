            ...
            <div className="px-4 py-2">
                ...
                <div>
                    <div className="flex items-center">
                        <button type="button" className="flex ml-2 items-center" onClick={() => setCommentsVisible(!commentsVisible)}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="fill-current text-gray-500 h-4 hover:text-gray-400">
                        ...
                        <button type="button" className="flex ml-6 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="fill-current text-gray-500 h-4 hover:text-gray-400">
                    ...
                    {commentsVisible &&
                        <div className="mt-6">
                            ...
                            <div className="flex">
                                ...
                                <button type="submit" className="text-white text-sm bg-green-400 rounded-full shadow text-center inline-flex items-center px-5 py-1 ml-2 hover:bg-green-300">
                                    Post
                                </button>
                            </div>
                        </div>
                ...
                <div className="flex">
                  ...
                  <button
                    type="submit"
                    className="button text-white bg-green-400 rounded-full shadow text-center inline-flex items-center p-2 ml-2 hover:bg-green-300"
                  >
                    <svg
