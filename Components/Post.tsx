    ...
    return (
        <div className="bg-white mb-6 p-4 rounded-lg shadow-md">
            <div className="px-4 py-2">
                ...
                <div>
                    <button type="button" className="ml-2" onClick={() => setCommentsVisible(!commentsVisible)}>
                    ...
                    {commentsVisible &&
                        <div className="mt-6">
                            ...
                            <div className="flex">
                                ...
                                <button type="submit" className="button text-white bg-green-400 rounded-full text-center inline-flex items-center p-2 ml-2 hover:bg-green-300">
